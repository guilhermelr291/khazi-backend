...
exports.default = (app) => {
    ...
    const loadRoutes = (dir) => {
        (0, fs_1.readdirSync)(dir, { withFileTypes: true }).forEach((file) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            if (file.isDirectory()) {
                ...
                (yield Promise.resolve(`${fullPath}`).then(s => __importStar(require(s)))).default(router);
            }
        }));
    };
